...
public class Opgave02 {
    public static void main(String[] args) {
        ...
        // Task A
        //get_vowel(characterArray);

        // Task B
        // dot_notation_counter(characterArray);
        // word_counter(characterArray);
        // long_words_counter(characterArray);
    ...
    /*
    // Task A
    public static void get_vowel(char[] arr) {
    ...
    */
    ...
    /*
    // Task B
    public static void dot_notation_counter(char[] arr){


    }
    public static void word_counter(char[] arr){


    }
    public static void long_words_counter(char[] arr){
